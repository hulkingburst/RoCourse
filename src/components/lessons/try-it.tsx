  ...
  return (
    <div className="border-t border-white/10">
      <button
        ...
        aria-expanded={open}
        className="flex w-full items-center gap-1.5 px-4 py-2 font-mono text-xs text-zinc-400 transition-all duration-150 hover:bg-white/5 hover:text-zinc-100 active:bg-white/10 motion-reduce:transition-none"
      >
            ...
            <div className="flex items-center gap-2 border-b border-white/10 px-4 py-2">
              ...
              <div className="ml-auto flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-md bg-primary px-3 py-1 text-xs font-semibold text-primary-foreground transition-all duration-150 hover:opacity-90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 motion-reduce:transition-none motion-reduce:active:scale-100"
                >
                  {running ? (
                    <>
                ...
                <button
                  ...
                  className="rounded-md p-1.5 text-zinc-400 transition-all duration-150 hover:bg-white/10 hover:text-zinc-200 active:scale-90 motion-reduce:transition-none motion-reduce:active:scale-100"
                >
